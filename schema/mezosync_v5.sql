-- mezosync v5 — СХЕМА КОНТУРА. СОБРАНА ИЗ ЖИВОЙ БАЗЫ, НЕ НАПИСАНА РУКОЙ.
--
...
--
-- собрано: index 19 · table 31 · view 6
...
CREATE TABLE IF NOT EXISTS role_skill (
    ...
    created_at  TEXT NOT NULL DEFAULT (datetime('now')), expired_at TEXT, expired_why TEXT,
    UNIQUE (role, skill)
);
