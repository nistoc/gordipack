...
def main():
    ...
    # 🪤 Третий раз тот же класс в этом файле, и лечение то же: сторож ищет каталог,
    ...
    # 🩸 Оплачено соседним контуром: их сторож ПЯТЬ СУТОК печатал ✅ про каталог, которого
    # у них не было вовсе. Чиним обе половины: сторож перестал выдавать пустоту за чистоту,
    ...
    for имя, зачем in (("coordination", "замороженные каналы и общие витрины"),
