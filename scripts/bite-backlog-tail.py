...
CREATE TABLE backlog (id INTEGER PRIMARY KEY, role TEXT, title TEXT, status TEXT,
                      ...
                      parent_track TEXT);
""")
# ↑ parent_track — как в живой схеме. Песочница БЕЗ него уже роняла сводку карточек после
# шага 0 пула (27.08): продукт читает поле, которого в песочнице не было, — класс
# «испытываем не то, что чиним». Таблицы tracks тут НЕТ намеренно: сводка обязана
