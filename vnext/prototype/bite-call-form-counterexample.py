...
flagged = "относительная в памятях ролей" in out
...
check("③", "относительная в памятях ролей" in out2, "живой относительный вызов ПО-ПРЕЖНЕМУ ловится",
      next((l.strip() for l in out2.splitlines() if "относительная в памятях ролей" in l), "")[:100])
...
check("④", "относительная в памятях ролей" in out3,
