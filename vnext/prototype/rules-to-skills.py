...
PACKAGES = {
    ...
    "atlas-acceptance": {
        ...
        "правила": ["acceptance-e2e", "gate-before-commit", "bytes-are-not-content",
                    ...
                    # ── 14.09 (слово владельца 2026-09-13 20:35:26 UTC «1 — все пять», раскладка
                    #    COORD — записка #5148): приёмка не пишет в живой контур и не судит его
                    #    сегодняшние данные
    ...
    "atlas-sync": {
        ...
        "правила": ["full-scan-every-tick", "no-pipe-tool-output", "ack-deadline",
                    ...
                    # ── 24.09: sync-alarm-in-chat и sync-sleep-backoff вынуты — будильники сверок
                    #    убираются (выбор владельца «Весь план», чат OPSSRE ~09:44 UTC, записка #5312:
                    #    роли зовут друг друга напрямую). Вынуты ДО снятия правил: навык со снятым
                    #    правилом сборка отвергает. Остальное о сверке (лента целиком) — на месте
                    "poll-format",
    ...
    "atlas-commit-push": {
        ...
        "правила": ["gate-before-commit", "coord-commits-coordination", "rule8-destructive",
                    ...
                    # ── 14.09 (записка #5148): правка общих инструментов «сделана», только
                    #    когда она на удалённом репозитории пакета и сверена
    ...
    "atlas-shared-edit": {
        ...
        "правила": ["shared-text-edit-sequence", "tool-edit-announce",
                    ...
                    # ── 14.09 (записка #5148): правишь инструмент — переводишь его имена
                    #    на английский тем же ходом; комментарии остаются русскими
    ...
    "atlas-task-card": {
        ...
        "правила": ["task-discipline", "task-states-and-role-card",
                    ...
                    "direction-focus",
                    # ── 14.09 (записка #5148): договорились о работе — решить, что отдать
                    #    помощнику на простой модели и кто примет его работу
