...
# ⛔ ПЕРЕВОД НА ОБЩИЙ РАЗЛИЧИТЕЛЬ (mention.py, #57) ПРИМЕРЕН И ОТКЛОНЁН ЗАМЕРОМ
# 10.08 00:04 UTC. Общий род «отмена» раздул широкий пробник 24→36, и все 12 новых —
# ЖИВЫЕ правила: «молчаливый пропуск запрещён», «вправе отменить одним словом»,
# «потолочных тиков больше нет». ПРАВИЛА И ЕСТЬ ЗАПРЕТЫ — для предмета «статус самого
# правила» слова запрещ/отмен/больше-не суть рабочий язык предписаний, а не отзыв.
# Пробник меряет разрыв «строгая пометка против ПРАВДОПОДОБНОГО поиска отозванных»;
# словарь, которым отозванное никто не ищет, завысил бы «% ложных» — то есть подделал
# бы замер в сторону собственной правоты. Словарь ниже — ПРЕДМЕТНЫЙ (слова о статусе
# правила), а не недописанная копия общего рода.
