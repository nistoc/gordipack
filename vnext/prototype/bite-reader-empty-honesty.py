...
⚠️ ЖИВАЯ БАЗА НЕ МУТИРУЕТСЯ: испытывается КОПИЯ, курсор двигается в ней.
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        case("③ витрина «только моё» по-прежнему честна",
             not claims_all_read(out) and "7" in out)
        ...
        case("④ курсор у головы — «непрочитанного нет» звучит и это правда",
