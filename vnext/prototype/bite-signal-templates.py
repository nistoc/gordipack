...
def main() -> int:
    ...
    try:
        ...
        print("")
        print(f"ИТОГ: {ЗЕЛЁНЫХ} из {CASES} · различающих {DIFFER}, из них ДОКАЗАНО порчей 9")
        ...
        # Доказаны порчей ВСЕ ДЕВЯТЬ: ① ② ④ ⑨ (автор) · ③ ⑤ ⑦ ⑧ (чужая рука, TAXO 18:57 UTC) ·
        # ⑥ (её же рецепт после починки 18:51). 🔑 Её находка, ради которой это и считается:
