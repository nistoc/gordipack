"""
bite-default-stamp.py — приёмка на правку ① : умолчание штампа 'backfill' → 'unset'.
...
по-прежнему нет ни в одной таблице — проверка `guard-mechanism-unused.py` так и будет
