...
"""measure-old-words — сколько прежних слов осталось: в памятях ролей и в пояснениях.
    ...
    python <ваш контейнер>/vnext-tools/measure-old-words.py           # обе половины
    python <ваш контейнер>/vnext-tools/measure-old-words.py --memories  # только памяти
    python <ваш контейнер>/vnext-tools/measure-old-words.py --short     # одна строка (для проверок)
